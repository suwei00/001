...
const { option: agentDepositAmountSort } = useOption('agentDepositAmountSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentDepositAmountSort" v-model="formData.sort"
            ...
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #deposit_amount="{ row }">
                        <div class="center">
                            <cg-amount :amount="row.deposit_amount" :size="26" :segmentation="true" suffix="K"
                                padding="0"></cg-amount>
                        </div>
                    </template>
                </CgTable>
