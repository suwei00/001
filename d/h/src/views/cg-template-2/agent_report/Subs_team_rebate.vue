...
const { option: agentTeamRebateSort } = useOption('agentTeamRebateSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentTeamRebateSort" v-model="formData.sort"
