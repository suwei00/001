...
const { option: agentNetAmountSort } = useOption('agentNetAmountSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentNetAmountSort" v-model="formData.sort"
