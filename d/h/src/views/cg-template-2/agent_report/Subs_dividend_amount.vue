...
const { option: agentDividendAmountSort } = useOption('agentDividendAmountSort');
...
const columns = ref([
    ...
    {
        title: 'Tiền<br/>Khuyến Mại',
        field: 'amount',
    },
    {
        title: 'Thời Gian<br/>Phát Thưởng',
        field: 'created_at',
    }
])
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentDividendAmountSort" v-model="formData.sort"
        ...
        <CgList ref="listRef" :list-api="APIs.getTradeDetail" :form-data="tableData">
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #amount="{ row }">
                        <cg-amount :amount="row.amount" :segmentation="true" suffix="K" padding="0"></cg-amount>
                    </template>
