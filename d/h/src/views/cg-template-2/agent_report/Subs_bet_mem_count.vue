...
const { option: agentBetMemberSort } = useOption('agentBetMemberSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentBetMemberSort" v-model="formData.sort"
            ...
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #bet_amount="{ row }">
                        <div class="center">
                            <cg-amount :amount="row.bet_amount" :size="26" :segmentation="true" suffix="K" padding="0"
