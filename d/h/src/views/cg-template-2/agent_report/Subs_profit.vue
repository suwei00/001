...
const { option: agentProfitSort } = useOption('agentProfitSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentProfitSort" v-model="formData.sort"
        ...
        <CgList ref="listRef" :list-api="APIs.getAgencySub" :form-data="tableData">
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #profit="{ row }">
                        <cg-amount :amount="row.profit" :segmentation="true" suffix="K" padding="0"
