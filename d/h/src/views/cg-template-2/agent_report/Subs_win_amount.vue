...
const { option: agentWinAmountSort } = useOption('agentWinAmountSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentWinAmountSort" v-model="formData.sort"
            ...
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #win_amount="{ row }">
                        <div class="center">
                            <cg-amount :amount="row.win_amount" :size="26" :segmentation="true" suffix="K" padding="0"
...
.sub {
    ...
    :deep(.cg-container-head:last-of-type) {
        .cg_default {
