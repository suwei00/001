...
const { option: agentWithdrawAmountSort } = useOption('agentWithdrawAmountSort');
...
const columns = ref([
    ...
    {
        title: 'Số Đơn<br/>Rút Tiền',
        field: 'withdrawal_count',
    },
    {
        title: 'Số Tiền<br/>Rút',
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentWithdrawAmountSort" v-model="formData.sort"
        ...
        <CgList ref="listRef" :list-api="APIs.getAgencySub" :form-data="tableData">
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #withdrawal_amount="{ row }">
                        <div class="center">
                            <cg-amount :amount="row.withdrawal_amount" :size="26" :segmentation="true" suffix="K"
                                padding="0"></cg-amount>
                        </div>
                    </template>
                </CgTable>
