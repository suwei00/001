...
const { option: agentCgRebateSort } = useOption('agentCgRebateSort');
    ...
    <div class="sub cg-list-container">
        <div class="input-container">
            <div class="time-sort">
                ...
                <div class="sort">
                    <cg-select rowKey="value" showLabelKey="label" :data="agentCgRebateSort" v-model="formData.sort"
            ...
            <template #default="{ data }">
                <CgTable :columns="columns" :table-data="data">
                    <template #cg_rebate="{ row }">
                        <cg-amount :amount="row.cg_rebate" :segmentation="true" suffix="K" padding="0"
