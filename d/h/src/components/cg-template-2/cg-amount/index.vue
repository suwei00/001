...
<template>
  <div class="cg_amount">
    <div :class="(colorClass, { underline: isClick })" @click="callBack" :style="`font-size:var(--cg-font-${size});font-weight:${weight};${color ? `color:var(--cg-color-${color})` : ''
    }`">
      <span :style="`padding-right:var(--cg-px-${padding})`">{{ setShowAmount(amount) }}</span>
