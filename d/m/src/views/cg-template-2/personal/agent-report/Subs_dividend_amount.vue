...
import { CgButton, CgAmount, CgTime, CgTable, CgTimeSwitch, CgInput, CgStyleDate, type CgTableColumns } from '@/components/cg-template-2';
...
const formData = ref({
  ...
  date_flag: props.dataList.tySub,
  ...
  <div class="sub">
    <div class="search-header">
      <div class="flex-1 flex ai-c">
        ...
        <!-- <cg-time-switch v-model="formData.date_flag" class="select-width mgr-25" /> -->
    ...
    <CgTable ref="cgTableRef" @sort="sort" :form-data="{ ...formData, ...curDate, date_flag: curDate.ty }" :columns="columns" :list-api="APIs.getTradeDetail">
      <template #amount="{ row }">
