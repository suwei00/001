...
import { CgButton, CgTable, CgTimeSwitch, CgInput, CgStyleDate, type CgTableColumns } from '@/components/cg-template-2';
...
<template>
  <div class="sub">
    ...
    <CgTable ref="cgTableRef" @sort="sort" :form-data="{ ...formData, ...curDate }" :columns="columns" :list-api="APIs.getAgencySub"> </CgTable>
  </div>
</template>
<script lang="ts">
export default {
