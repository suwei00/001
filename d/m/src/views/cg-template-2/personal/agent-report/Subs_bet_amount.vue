...
import { CgButton, CgAmount, CgTimeSwitch, CgTable, CgInput, CgStyleDate, type CgTableColumns } from '@/components/cg-template-2';
  ...
  <div class="sub">
    <div class="search-header">
      <div class="flex-1 flex ai-c">
        ...
        <cg-style-date v-model="curDate" topFix leftFix width="257" class="select-width mgr-25" @change="selectChange" />
