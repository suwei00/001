...
.cg-switch {
  --cg-switch-width: 50px;
  --cg-switch-height: 26px;
  --cg-switch-circle-width: 21px;
  --cg-switch-circle-height: 21px;
}

.cg-switch {
  width: var(--cg-switch-width);
  height: var(--cg-switch-height);
  background: linear-gradient(90deg, var(--cg-color-blue9) 0%, var(--cg-color-blue10) 100%);
  border-radius: 100px;
  padding: 3px;
  ...
  .content {
    ...
    &.off {
      background-color: var(--cg-color-blue8);
    }
