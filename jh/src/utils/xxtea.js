import xxaqt from '~/utils/xxaqt'
const xxtea = {
  // KEYS: { 23: '3693378124', 24: '3468719701', 25: '2085999532' },
  KEYS: { 23: '3693378124', 24: '3468719701', 25: xxaqt.keyVal },
  DELTA: 0x9E3779B9,
...
export function encryptQuery(params = {}) {
  ...
  const body = encryptToBase64(query.join('&'), xxtea.KEYS['25'])

  // console.log('1=====>', decryptFromBase64(body, xxtea.KEYS['25']));
  return body
}

export function decryptQuery(body) {
  const query = decryptFromBase64(body, xxtea.KEYS['25'])
